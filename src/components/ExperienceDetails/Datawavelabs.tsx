    ...
    <div>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8 overflow-hidden rounded-lg shadow-lg">
          <img
            src={assets.proffessionalThings.datawavelabs.datawaveDashboard.src}
            width={1200}
            height={800}
            alt="DatawaveLabs"
      ...
      <section className="mb-12">
        ...
        <p className="text-muted-foreground">
          ...
          scalable application development, laying a strong foundation for future professional endeavors.
        </p>
      </section>
...
const datwaveLabsExp = {
  work: [
    ...
    },
    {
      ...
      description: "Automated cluster management workflows for infrastructure deployment. My contributions included:",
      items: [
    ...
    },
    {
      ...
      description: "Worked extensively on the frontend using modern tools to enhance usability:",
      items: [
    ...
    },
    {
      ...
      description: "Contributed to the project's scalability and reliability through DevOps practices:",
      items: [
